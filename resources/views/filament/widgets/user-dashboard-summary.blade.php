<div class="grid gap-6 lg:grid-cols-3">
    <div class="surface-card p-6 lg:col-span-1">
        <div class="text-sm font-semibold uppercase tracking-[0.2em] text-[#3E271A]">Profil</div>
    ...
    <div class="surface-card p-6 lg:col-span-2">
            <div class="text-sm font-semibold uppercase tracking-[0.2em] text-[#3E271A]">Riwayat Presensi</div>
        <div class="mt-4 space-y-3">
            @forelse ($attendanceHistory as $item)
                <div class="rounded-xl border border-[#3E271A]/10 p-4">
    ...
    <div class="surface-card p-6 lg:col-span-3">
        <div class="grid gap-6 xl:grid-cols-3">
            <div>
                <div class="text-sm font-semibold uppercase tracking-[0.2em] text-[#3E271A]">Berita Saya</div>
                <div class="mt-4 space-y-3">
            ...
            <div class="xl:col-span-2">
                <div class="text-sm font-semibold uppercase tracking-[0.2em] text-[#3E271A]">Agenda Mendatang</div>
                <div class="mt-4 space-y-3">
