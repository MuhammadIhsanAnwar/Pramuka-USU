...
@section('content')
<section class="w-full bg-top relative overflow-hidden" style="min-height: 420px; {{ $backgroundImage ? "background-image: url('{$backgroundImage}');" : '' }} background-size: cover; background-position: top center; background-repeat: no-repeat;">
