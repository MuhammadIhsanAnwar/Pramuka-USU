...
<{{ $tag }}
    ...
    style="border-radius: 999px; background-color: #3E271A; color: #fff; border: 1px solid #3E271A; padding: 0.7rem 1rem; font-weight: 600; box-shadow: 0 4px 10px rgba(62,39,26,0.12);"
>
