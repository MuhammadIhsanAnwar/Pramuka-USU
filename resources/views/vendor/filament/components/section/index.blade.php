...
<section
    style="border: 1px solid rgba(62, 39, 26, 0.12); border-radius: 24px; background: #ffffff; box-shadow: 0 8px 24px rgba(62, 39, 26, 0.08); overflow: hidden;"
...
>
    @if ($hasHeader)
        <header
            style="padding: 1.1rem 1.2rem; border-bottom: 1px solid rgba(62, 39, 26, 0.08); background: linear-gradient(90deg, rgba(248,244,234,0.75), rgba(255,255,255,0.95));"
            @if ($collapsible)
